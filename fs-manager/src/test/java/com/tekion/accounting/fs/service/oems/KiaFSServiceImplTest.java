...
public class KiaFSServiceImplTest extends TestCase {
    ...
    public void testGenerateXML() {
        assertNotNull(kiaFSService.generateXML(getFinancialStatementRequestDto()));
    }
    ...
    public void testDownloadFile() throws IOException {
        ...
        kiaFSService.downloadFile(getFinancialStatementRequestDto(), httpServletResponse);
    }
