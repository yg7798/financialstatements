...
import com.tekion.accounting.fs.cache.dtos.OptionDeptMinimal;
...
public class CustomFieldCache extends AbstractRedisCache<CustomFieldCacheDto> {
    ...
    protected CustomFieldCacheDto populateFromDB() {
        ...
        try {
            customFieldCacheDto.setKeyToOptionIdToOptionMap(getKeyToOptionIdToOptionMap(preferenceClient.getCustomFields(ACCOUNTS_CF_ASSET_TYPE).getData()));
