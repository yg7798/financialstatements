...
import com.tekion.accounting.fs.excelGeneration.enums.ConditionalRule;
import com.tekion.accounting.fs.excelGeneration.enums.ExcelFieldIdentifier;
import com.tekion.accounting.fs.excelGeneration.enums.SupportedFormatOverrideIdentifiers;
import com.tekion.accounting.fs.excelGeneration.rules.ExcelColumnConditioningRule;
import com.tekion.accounting.fs.excelGeneration.rules.ExcelConditionalRuleFactory;
...
import static com.tekion.accounting.fs.excelGeneration.columnConfigs.ExcelColumnConfigGeneratorUtil.*;
...
public interface AccAbstractColumnConfig extends AbstractColumnConfig {
    ...
    static String getBeanKeyForGivenSortKeySentByUI(String requestSortKey, String configClassName) {
        registerClassInSortKeyMap(configClassName);
    ...
    static List<AccAbstractColumnConfig> getConditionedColumnsForConfig( String configClassName) {
        registerClassInConditionedColumnsMap(configClassName);
    ...
    static Map<String, AccAbstractColumnConfig> getPreferenceKeyToEnumMap( String configClassName) {
        registerClassInPreferenceKeyMap(configClassName);
    ...
    static Map<String, List<AccAbstractColumnConfig>> getPreferenceKeyToEnumListMap( String configClassName) {
        registerClassInPreferenceKeyToEnumListMap(configClassName);
    ...
    static List<AccAbstractColumnConfig> getEnumList( String configClassName) {
        registerClassForEnumList(configClassName);
    ...
    static Map<ColumnFreezeType, List<AccAbstractColumnConfig>> getFrozenTypeToEnumListMap( String configClassName) {
        registerClassForColumnFreezeMapping(configClassName);
